...
exports.wallet = exports.adminContractKey = exports.tokenContractKey = exports.testKeys = void 0;
...
const testKeys = testKeysInternal.map((key) => o1js_1.Mina.TestPublicKey.fromBase58(key.privateKey));
exports.testKeys = testKeys;
const [tokenContractKey, adminContractKey] = contractKeys.map((key) => o1js_1.Mina.TestPublicKey.fromBase58(key.privateKey));
exports.tokenContractKey = tokenContractKey;
exports.adminContractKey = adminContractKey;
const wallet = o1js_1.PublicKey.fromBase58("B62qqhvKVk2KEia7awrhNM1nPLUEXDM8WiPut7xXKrNDYDae1JU5GzN");
